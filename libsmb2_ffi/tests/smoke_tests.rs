use smb2_rust::{
    ...
    dcerpc_set_endian, dcerpc_set_size_is, dcerpc_set_tctx, dcerpc_utf16z_coder,
...
fn ffi_srvsvc_share_info_1_coder_matches_coder_test_vector() {
    ...
    assert_eq!(
        &buffer[..offset as usize],
        &[
            0x55, 0x70, 0x74, 0x72, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00,
            0x00, 0x00, 0x49, 0x00, 0x50, 0x00, 0x43, 0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x03, 0x00, 0x00, 0x80, 0x55, 0x70, 0x74, 0x72, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00,
